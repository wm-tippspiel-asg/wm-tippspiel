...
> Sondertipps können nur bis zum Anpfiff des ersten Spiels (11. Juni 2026) abgegeben werden.
...
[Claude Code](https://code.claude.com/docs/de/overview) ist ein bezahltes KI-Modell von Anthropic. Man hat nur eine bestimmte Anzahl von Tokens bzw. eine bestimmte Usage, die man nutzen kann. Mit diesem Projekt wurden bis jetzt insgesamt ca. **600.000 Input Tokens** und ca. **300.000 Output Tokens** verbraucht (cache tokens lassen wir mal weg). Das entspricht beim Claude Max ×5-Plan einer Usage von ca. **40 % des Weekly Limits**. Zudem wurde noch Claude Design benutzt, welches für das Design verantwortlich war. Claude Design ist ebenfalls nur im Paid Plan enthalten.

![Usage](https://github.com/wm-tippspiel-asg/wm-tippspiel/blob/main/public/usage.png?raw=true)
...
**[01.06.2026- 23:42 Uhr]**: Erster Bug gefunden von Aaron. Kleiner AI Fehler. Der Bug war eine Race Condition, dass heißt zwei User können den gleichen Access Token benutzen. Der Fix: Einfach eine Bedingung einbauen die das checkt.
...
**[02.06.2026- 15:30 Uhr]**: Update: Auf Wunsch von Herrn Moellmann wurde ein Gruppensystem integriert. Es gibt nun sowohl eine Einzel- als auch eine Gruppenwertung.
